...
function loadRubros() {
    var data_table_config = {
        "ajax": {
            "url": base_url() + "/sistemacontable/rubros_controller/load_rubro",
            "type": "post",
            "data": { 'st': 0 },
...
function sendForm(id) {
    ...
    $.ajax({
        type: 'POST',
        url: base_url() + "/sistemacontable/rubros_controller/crear_rubro",
        data: data,
...
function eliminarRubro(rubro_id) {
    $.ajax({
        type: 'POST',
        url: base_url() + "/sistemacontable/rubros_controller/delete_rubro",
        data: { 'id': rubro_id },
        success: function (data, textStatus, request) {
            if (data.success == false) {
                //seteo los errores en el formlario
