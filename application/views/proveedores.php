        ...
        <div class="row">
          ...
          <div class="col-md-8 col-md-offset-2">
            ...
            <div class="box box-primary">
              ...
              <form class='form-proveedor' data-proveedorid='' >
                <div class="box-body">
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title">Proveedores Activos</h3>
              </div>
              <div class="box-body">
                <div id="tbl_proveedor_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                  <div class="row">
                    <div class="col-sm-6"></div>
                    <div class="col-sm-6"></div>
                  </div>
                  <div class="row"><div class="col-sm-12">
                  <table id="tbl_proveedor" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
              </div>
            </div>
          </div>
        </div>
