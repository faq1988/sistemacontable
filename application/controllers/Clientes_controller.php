  ...
  {    
    ...
    if ($this->form_validation->run() == FALSE)      
      {  
        ...
        $res = $this->clientes_model->crear_cliente(compact('id','razon_social','categoria_iva','tipo_documento','cuit','domicilio','altura','piso','departamento','localidad','telefono','email'));
