...
define ("CERT", "certificado.pem");       # The X.509 obtained from Seg. Inf.
define ("PRIVATEKEY", "key"); # The private key correspoding to CERT
define ("PASSPHRASE", "faq123456"); # The passphrase (if any) to sign
# SERVICE: The WS service name you are asking a TA for
define ("SERVICE", "dummy");
...
function SignTRA()
{
  ...
  $STATUS=openssl_pkcs7_sign(realpath("TRA.xml"), "TRA.tmp", "file://".realpath(CERT),
